<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('setting_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/districts*") ? "c-show" : "" }} {{ request()->is("admin/blocks*") ? "c-show" : "" }} {{ request()->is("admin/panchayats*") ? "c-show" : "" }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @can('panchayat_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.panchayats.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/panchayats") || request()->is("admin/panchayats/*") ? "c-active" : "" }}">
